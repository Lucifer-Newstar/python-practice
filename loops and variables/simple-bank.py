#just so I should learn how to give documentation you need to read this
#this is just a simple bank program using simple looping statements 
#yes code logic might be dumb but I'm cool 


#get acc no and assign amount
acc_no = input("Enter your account number:")
#just because this is a sample program you can't expect me to let you give random ahh bullshi in the account number(ig you could still do)
while len(acc_no)<14 or len(acc_no)>14: # I could use len(acc_no) != 14 but I won't
    print ("Account number is wrong")
    acc_no = input("Enter your account number:")
#considering you are NOT broke enough yet
initial_amount = 500
